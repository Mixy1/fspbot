...
async function accessSpreadsheet() {
    ...
    const exampleEmbed = new Discord.MessageEmbed()
                        ...
                        .addFields(
                            ...
                            { name: 'lower bound:', value: parseInt(lowerbound/60) + 'min', inline: true },
                            { name: 'upper bound:', value: parseInt(upperbound/60) + 'min', inline: true },
                        )
    ...
    if (discord_enabled){
        client.channels.cache.get("820219287938793523").messages.fetch("820223123672137740").then(message => message.edit(exampleEmbed));
    }
}
